...
internal sealed class NullReferenceExceptionBinarySerializer : ExceptionSerializerBase<NullReferenceException>
{
    ...
    protected override NullReferenceException DeserializeCore(string message, Exception? innerException, ref ReadOnlySequenceReader<byte> source, BinarySerializationContext context)
    {
