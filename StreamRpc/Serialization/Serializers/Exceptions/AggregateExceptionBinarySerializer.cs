...
internal sealed class AggregateExceptionBinarySerializer : ExceptionSerializerBase<AggregateException>
{
    ...
    protected override AggregateException DeserializeCore(string message, Exception? innerException, ref ReadOnlySequenceReader<byte> source, BinarySerializationContext context)
    {
