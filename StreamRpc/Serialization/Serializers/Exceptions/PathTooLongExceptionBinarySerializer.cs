...
internal sealed class PathTooLongExceptionBinarySerializer : ExceptionSerializerBase<PathTooLongException>
{
    ...
    protected override PathTooLongException DeserializeCore(string message, Exception? innerException, ref ReadOnlySequenceReader<byte> source, BinarySerializationContext context)
    {
