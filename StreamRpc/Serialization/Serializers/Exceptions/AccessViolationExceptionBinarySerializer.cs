...
internal sealed class AccessViolationExceptionBinarySerializer : ExceptionSerializerBase<AccessViolationException>
{
    ...
    protected override AccessViolationException DeserializeCore(string message, Exception? innerException, ref ReadOnlySequenceReader<byte> source, BinarySerializationContext context)
    {
